<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="ShippingOffice.aspx.cs" Inherits="ProcessAutomation.Pulpits.ShippingOffice" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContent" runat="server">
    <div style="text-align:center" class="auto-style93">
        <span class="bold">Shipping Office</span></div>
                ...
                <td class="auto-style6">
                    <table cellpadding ="2" style="margin-bottom: 0px; height: 604px;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:bottom; text-align:right" class="auto-style35">
                                <br />
                                <asp:ImageButton ID="COM11A" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1904_Click" ToolTip="BHW-WS1904" BorderColor="#FF3300"/>
                            </td>
                            <td style="vertical-align:bottom; text-align:right" class="auto-style35">
                                <asp:ImageButton ID="COM11B" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1904_Click" ToolTip="BHW-WS1904" BorderColor="#FF3300"/>
                            </td>
                            <td style="vertical-align:top; text-align:right" class="auto-style54">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                                <asp:ImageButton ID="COM11B0" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1840_Click" ToolTip="BHW-WS1840" BorderColor="#FF3300"/>
                            </td>
                            <td style="vertical-align:bottom; text-align:right" class="auto-style29">
                                ...
                                <asp:ImageButton ID="COM11B1" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1840_Click" ToolTip="BHW-WS1840" BorderColor="#FF3300"/>
                                        </td>
                            ...
                            <td class="auto-style32">
                                &nbsp;
                                <asp:ImageButton ID="COM11B2" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="MANH4_Click" ToolTip="BHW-GEN-MANH4" BorderColor="#FF3300"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style77">
                                &nbsp;
                                <asp:Image ID="Operator0" runat="server" Imageurl="../Pictures/(fixed)chairfaceup.png" Height="79px" Width="84px" ToolTip="Chair"/>
                            </td>
                            ...
                            <td class="auto-style81" >
                                &nbsp;
                                <asp:Image ID="Operator1" runat="server" Imageurl="../Pictures/(fixed)chairfaceup.png" Height="79px" Width="84px" ToolTip="Chair"/>
                            </td>
                            <td class="auto-style80" >
                                &nbsp;
                            </td>
