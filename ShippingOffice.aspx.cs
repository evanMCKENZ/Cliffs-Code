...
{
    public partial class ShippingOffice: System.Web.UI.Page
    {
        ...
        protected void WS1904_Click(object sender, ImageClickEventArgs e)
        {
            ActualCompName2.Text = "BHW-WS1904";
            this.Border(COM11A, COM11B);
        }
        protected void WS1840_Click(object sender, ImageClickEventArgs e)
        {
            ActualCompName2.Text = "BHW-WS1840";
            this.Border(COM11B1, COM11B0);
        }
        protected void MANH4_Click(object sender, ImageClickEventArgs e)
        {
            ActualCompName2.Text = "BHW-GEN-MANH4";
            this.Border(COM11B2, COM11B2);
        }
...
*/
        protected void Border(ImageButton Border1, ImageButton Border2)
        {
           // DECTALK.BorderStyle = BorderStyle.None;
            ...
            COM11B.BorderStyle = BorderStyle.None;
            COM11B2.BorderStyle = BorderStyle.None;
            COM11B1.BorderStyle = BorderStyle.None;
            COM11B0.BorderStyle = BorderStyle.None;
