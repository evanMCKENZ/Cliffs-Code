<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Shipping4.aspx.cs" Inherits="ProcessAutomation.Pulpits.Shipping4" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContent" runat="server">
    <div style="text-align:center" class="auto-style93">
        <span class="bold">Shipping 4</span></div>
                ...
                <td class="auto-style6">
                    <table cellpadding ="2" style="margin-bottom: 0px; height: 604px;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:bottom; text-align:right" class="auto-style35">
                                <br />
                                <asp:ImageButton ID="COM11A" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1919_Click" ToolTip="WS1919" BorderColor="#FF3300"/>
                            </td>
                            <td style="vertical-align:bottom; text-align:right" class="auto-style35">
                                <asp:ImageButton ID="WS1919" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1919_Click" ToolTip="WS1919" BorderColor="#FF3300"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:left; vertical-align:top" class="auto-style87">
                                <asp:ImageButton ID="CR526" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="CR526_Click" ToolTip="CR526" BorderColor="#FF3300"/>
                            </td>
                            <td class="auto-style87">
                                &nbsp;
                            </td>
