<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="managerOffice.aspx.cs" Inherits="ProcessAutomation.Pulpits.managerOffice" %>
                ...
                <td class="auto-style6">
                    <table cellpadding ="2" style="margin-bottom: 0px; height: 604px;">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:bottom; text-align:right" class="auto-style35">
                                <br />
                                <asp:ImageButton ID="COM11A" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1805_Click" ToolTip="WS1805" BorderColor="#FF3300"/>
                            </td>
                            <td style="vertical-align:bottom; text-align:right" class="auto-style35">
                                <asp:ImageButton ID="WS1805" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1805_Click" ToolTip="WS1805" BorderColor="#FF3300"/>
                            </td>
                            <td style="vertical-align:top; text-align:right" class="auto-style54">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                                <asp:ImageButton ID="COM11B0" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1799_Click" ToolTip="WS1799" BorderColor="#FF3300"/>
                            </td>
                            <td style="vertical-align:bottom; text-align:right" class="auto-style29">
                                ...
                                <asp:ImageButton ID="WS1799" runat="server" Imageurl="../Pictures/CPU31.png" Height="79px" Width="84px" OnClick="WS1799_Click" ToolTip="WS1799" BorderColor="#FF3300"/>
                                        </td>
